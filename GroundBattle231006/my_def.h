...
#define sgd (s_grid)
#define tlgd (cur.tl_grid)
#define gtcl(pgd) (get_cell(cur, pgd))
#define tlcl(pgd) (tl_cell(cur, pgd))

#define rdt (cur.real_dt)
#define cm (*cur.cam)
#define cv (cur.canvas)
#define nxcv (cur.nx_canvas)
#define nycv (cur.ny_canvas)
#define agsel (cur.agent_sel)
#define bdc (*cur.broad)
